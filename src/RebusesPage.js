    ...
    return(
        <div className="card col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 rebus_body">
            <div className="card-body card_body">
                ...
                <OpenRebusButton data_bs_toggle="modal" data_bs_target="#exampleModal" cn="fillable" text="open rebus"></OpenRebusButton>
                {ttt==true?
                (
...
export default class RebusesPage extends Component{
    ...
    constructor(props){
        ...
        this.setRebusNumber = this.setRebusNumber.bind(this);
    }

    setRebusNumber(number){
        console.log("hello")
        this.setState({
            rebusNumber:number
        })
        console.log("hello" + this.rebusNumber)
    }
            ...
            <div className="container">
                ...
                <div className="container cards_holder">
                    <div className="row cards_row">
                        <Rebus setRebusNumber={()=>this.setRebusNumber(12)} number="1"></Rebus>
                ...
                <RebusWindow number={124}></RebusWindow>
            </div>
        )
    }
}
